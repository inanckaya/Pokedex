...
const createPokemonBox = (pokemon) => {
    ...
    const id = pokemon.id.toString().padStart (3, '0');   //padStart Kaç tane karakter ile başlayacağını belirlemeye yarar boş olan ilk 2 karaktere 0 yaz dedim //
...
searchInput.addEventListener('input', function (e) {
    ...
    const search = searchInput.value.toLowerCase();   // Harfler küçük olmazsa mobilde sorun çıkarır //
